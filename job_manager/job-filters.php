...
<form class="job_filters">
	...
	<div class="search_jobs">
        ...
        <label for="job_state_any" class="any"><input type="checkbox" name="filter_state[]" value="any" checked="checked" id="job_state_any"> Any</label>
        
        <label for="job_state_remote" class="remote"><input type="checkbox" name="filter_state[]" value="remote" checked="checked" id="job_state_remote"> Remote</label>
        </div>
